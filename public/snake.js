...
async function initializeFarcaster() {
  try {
    ...
    // Get frame context (removed await because context is not a promise)
...
if (!canvas) {
  ...
  // Prevent further execution if canvas is missing
  throw new Error('Canvas #game element missing');
}
